...
local function Register()
    ...
    do
        ...
        latencySetting     = Settings.RegisterAddOnSetting(category, variable, variable, variableTbl, type(defaultValue),
            name, defaultValue)
        Settings.SetOnValueChangedCallback(variable, OnSettingChanged)
    ...
    do
        ...
        latencyHomeSetting = Settings.RegisterAddOnSetting(category, variable, variable, variableTbl, type(defaultValue),
            name, defaultValue)
        Settings.SetOnValueChangedCallback(variable, OnSettingChanged)
    ...
    do
        ...
        latencyWorldSetting = Settings.RegisterAddOnSetting(category, variable, variable, variableTbl, type(defaultValue),
            name, defaultValue)
        Settings.SetOnValueChangedCallback(variable, OnSettingChanged)
    ...
    do
        ...
        local setting = Settings.RegisterAddOnSetting(category, variable, variable, variableTbl, type(defaultValue), name,
    ...
    do
        ...
        changeColorSetting = Settings.RegisterAddOnSetting(category, variable, variable, variableTbl, type(defaultValue),
            name, defaultValue)
        Settings.SetOnValueChangedCallback(variable, OnSettingChanged)
